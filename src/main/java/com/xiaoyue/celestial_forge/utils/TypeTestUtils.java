...
public class TypeTestUtils {
	...
	public static boolean isRangedWeapon(ItemStack stack) {
		if (!CFModConfig.SERVER.enableRangedForging.get()) return false;
	...
	public static boolean isTool(ItemStack stack) {
		if (!CFModConfig.SERVER.enableToolForging.get()) return false;
	...
	public static boolean isArmor(ItemStack stack) {
		if (!CFModConfig.SERVER.enableArmorForging.get()) return false;
		return stack.getItem() instanceof ArmorItem ||
				stack.is(CFTagGen.ARMOR_MODIFIABLE);
	}

	public static boolean isWeapon(ItemStack stack) {
		if (!CFModConfig.SERVER.enableWeaponForging.get()) return false;
