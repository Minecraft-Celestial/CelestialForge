	...
	static {
		MODIFIER_CONFIG = new ModifierDataBuilder()
				...
				.put(CelestialForge.loc("armor_basic"),
						...
						UpgradeRecipeBuilder.of(12, Items.TURTLE_HELMET, Items.ENCHANTED_BOOK, Items.CRYING_OBSIDIAN, Items.ARMADILLO_SCUTE, Items.GOLDEN_CHESTPLATE),
				...
				.put(CelestialForge.loc("hard"), 300, Attributes.ARMOR, 2, ADD_VALUE)
				.put(CelestialForge.loc("guarding"), 200, Attributes.ARMOR, 0.05, ADD_MULTIPLIED_BASE)
				.put(CelestialForge.loc("armor"), 100, Attributes.ARMOR_TOUGHNESS, 1, ADD_VALUE)
				.put(CelestialForge.loc("protect"), 150, Attributes.ARMOR_TOUGHNESS, 0.05, ADD_MULTIPLIED_BASE)
				.end()
				...
				.put(CelestialForge.loc("armor_advanced"),
						...
						UpgradeRecipeBuilder.of(12, Items.TURTLE_HELMET, Items.EXPERIENCE_BOTTLE, Items.ENCHANTED_BOOK, Items.CRYING_OBSIDIAN, Items.ARMADILLO_SCUTE, Items.GOLDEN_CHESTPLATE),
				...
				.put(CelestialForge.loc("solid"), 50,
						new ModifierEntry(Attributes.ARMOR, 2, ADD_VALUE),
						new ModifierEntry(Attributes.ARMOR_TOUGHNESS, 2, ADD_VALUE),
						new ModifierEntry(Attributes.KNOCKBACK_RESISTANCE, 0.1, ADD_VALUE))
				.put(CelestialCore.loc("regenerate"), 150, L2DamageTracker.REGEN.holder(), 0.05, ADD_MULTIPLIED_BASE)
				.end()
				.end()
				...
				.put(CelestialForge.loc("tool_basic"),
						...
						UpgradeRecipeBuilder.of(47, Items.NETHERITE_SHOVEL, CCItems.SHULKER_SCRAP.get(), CCItems.LIGHT_FRAGMENT.get(), Items.DRAGON_BREATH),
						UpgradeRecipeBuilder.of(57, CCItems.REINFORCED_OCEAN_INGOT.get(), CCItems.EARTH_CORE.get(), Items.END_ROD, Items.TOTEM_OF_UNDYING)
				)
				.put(CelestialForge.loc("luck"), 100, Attributes.LUCK, 1, ADD_VALUE)
				.end()
				...
				.put(CelestialForge.loc("strength"), 150, L2DamageTracker.BOW_STRENGTH.holder(), 0.05, ADD_VALUE)
				.put(CelestialForge.loc("fatal"), 150, L2DamageTracker.BOW_STRENGTH.holder(), 0.05, ADD_MULTIPLIED_BASE)
				.end()
				...
				.put(CelestialForge.loc("unreal"), 50,
						new ModifierEntry(L2DamageTracker.BOW_STRENGTH.holder(), 0.1, ADD_MULTIPLIED_BASE),
						new ModifierEntry(L2DamageTracker.CRIT_DMG.holder(), 0.1, ADD_VALUE),
						new ModifierEntry(Attributes.MOVEMENT_SPEED, 0.05, ADD_MULTIPLIED_BASE))
				.end().end()
				...
				.put(CelestialForge.loc("accurate"), 200, L2DamageTracker.CRIT_RATE.holder(), 0.02, ADD_VALUE)
				.put(CelestialForge.loc("senior"), 200, L2DamageTracker.CRIT_DMG.holder(), 0.02, ADD_VALUE)
				.put(CelestialForge.loc("devil"), 150, L2DamageTracker.CRIT_DMG.holder(), 0.05, ADD_MULTIPLIED_BASE)
				.put(CelestialForge.loc("sawtooth"), 300, Attributes.ATTACK_DAMAGE, 1, ADD_VALUE)
				.put(CelestialForge.loc("spine"), 200, Attributes.ATTACK_DAMAGE, 0.05, ADD_MULTIPLIED_BASE)
				.end()
				...
				.put(CelestialCore.loc("puncture"), 70,
						new ModifierEntry(CCAttributes.ARMOR_PENETRATION.holder(), 0.1, ADD_VALUE))
				.put(CelestialForge.loc("rude"), 75,
						new ModifierEntry(L2DamageTracker.CRIT_RATE.holder(), -0.05, ADD_VALUE),
						new ModifierEntry(L2DamageTracker.CRIT_DMG.holder(), 0.1, ADD_VALUE))
				.put(CelestialForge.loc("insane"), 100,
						new ModifierEntry(Attributes.ATTACK_DAMAGE, -0.05, ADD_MULTIPLIED_BASE),
						new ModifierEntry(Attributes.ATTACK_SPEED, 0.1, ADD_MULTIPLIED_BASE))
				.put(CelestialForge.loc("legend"), 50,
						new ModifierEntry(Attributes.ATTACK_DAMAGE, 0.1, ADD_MULTIPLIED_BASE),
						new ModifierEntry(Attributes.ATTACK_SPEED, 0.1, ADD_MULTIPLIED_BASE),
						new ModifierEntry(L2DamageTracker.CRIT_RATE.holder(), 0.05, ADD_VALUE))
				.end()
				.end()
				...
				.put(CelestialForge.loc("rash"), 200, Attributes.ATTACK_SPEED, 0.2, ADD_VALUE)
				.put(CelestialForge.loc("brave"), 150, Attributes.ATTACK_SPEED, 0.05, ADD_MULTIPLIED_BASE)
				.put(CelestialForge.loc("dangerous"), 150, L2DamageTracker.EXPLOSION_FACTOR.holder(), 0.05, ADD_MULTIPLIED_BASE)
				.put(CelestialForge.loc("magic_energy"), 150, L2DamageTracker.MAGIC_FACTOR.holder(), 0.05, ADD_MULTIPLIED_BASE)
				.put(CelestialForge.loc("red_hot"), 150, L2DamageTracker.FIRE_FACTOR.holder(), 0.05, ADD_MULTIPLIED_BASE)
				.end()
				...
				.put(CelestialForge.loc("life"), 75,
						new ModifierEntry(Attributes.MAX_HEALTH, 2, ADD_VALUE),
						new ModifierEntry(L2DamageTracker.ABSORB.holder(), 2, ADD_VALUE))
				.put(CelestialForge.loc("anger"), 100,
						new ModifierEntry(Attributes.ATTACK_KNOCKBACK, 1, ADD_VALUE),
						new ModifierEntry(L2DamageTracker.REDUCTION.holder(), -0.05, ADD_MULTIPLIED_TOTAL))
				.end()
				.end()
				...
				.put(CelestialForge.loc("fast"), 150, Attributes.MOVEMENT_SPEED, 0.05, ADD_MULTIPLIED_BASE)
				.end()
				.end();
		...
		REINFORCE_CONFIG = new ReinforceDataBuilder()
				...
				.attr(Attributes.MOVEMENT_SPEED, 0.05, ADD_MULTIPLIED_BASE).build()

				.builder("heart_fragment").mate(CCItems.HEART_FRAGMENT).temp(Items.EMERALD)
				.type(ModifierType.ARMOR).type(ModifierType.CURIO)
				.attr(Attributes.MAX_HEALTH, 2, ADD_VALUE).build()

				.builder("heart_of_the_sea").mate(Items.HEART_OF_THE_SEA).temp(Items.LAPIS_LAZULI)
				.type(ModifierType.ARMOR).type(ModifierType.CURIO)
				.attr(Attributes.WATER_MOVEMENT_EFFICIENCY, 0.04, ADD_MULTIPLIED_BASE).build()

				.builder("dragon_head").mate(Items.DRAGON_HEAD).temp(Items.CHORUS_FRUIT)
				.type(ModifierType.WEAPON)
				.attr(Attributes.ATTACK_DAMAGE, 0.05, ADD_MULTIPLIED_BASE).build()

				.builder("scute").mate(Items.ARMADILLO_SCUTE).temp(Items.SAND)
				.type(ModifierType.ARMOR).type(ModifierType.CURIO)
				.attr(Attributes.ARMOR_TOUGHNESS, 0.03, ADD_MULTIPLIED_BASE).build();
	}

	public CFConfigGen(DataGenerator generator, CompletableFuture<HolderLookup.Provider> pvd) {
		super(generator, pvd, "CelestialForge config provider");
	}
