...
public enum CFLang {
	...
	public static MutableComponent attr(@Nullable Holder<Attribute> attr) {
		return attr == null ? Component.empty() : Component.translatable(attr.value().getDescriptionId()).withStyle(ChatFormatting.AQUA);
	}
