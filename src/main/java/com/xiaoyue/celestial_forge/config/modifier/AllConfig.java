...
public class AllConfig {
    ...
    static {
        ...
        OPERATIONS_IDS = BUILDER
                ...
                .defineList("OPERATIONS_IDS", Lists.newArrayList(), o -> true);
        BUILDER.pop();
