...
public class ArmorConfig {
    ...
    static {
        ...
        NAMES = BUILDER
                ...
                .defineList("NAMES", Lists.newArrayList("hard", "guarding", "armor", "protect"), o -> true);
        WEIGHTS = BUILDER
                .comment("The weight of the modifier in the modifiers pool")
                .defineList("WEIGHTS", Lists.newArrayList("300", "200", "100", "150"), o -> true);
        ATTRIBUTES = BUILDER
                .comment("The attribute of the modifier has. One modifier can have multiple attributes. Use ';' to split different attributes")
                .defineList("ATTRIBUTES", Lists.newArrayList("minecraft:generic.armor", "minecraft:generic.armor", "minecraft:generic.armor", "minecraft:generic.armor_toughness"), o -> true);
        AMOUNTS = BUILDER
                .comment("The amount used to calculate the attribute effect. Also can be multiple. Use ';' to split")
                .defineList("AMOUNTS", Lists.newArrayList("1.0", "2.0", "4.0", "2.0"), o -> true);
        OPERATIONS_IDS = BUILDER
                ...
                .defineList("OPERATIONS_IDS", Lists.newArrayList("0", "0", "0", "0"), o -> true);
        BUILDER.pop();
